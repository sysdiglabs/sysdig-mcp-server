'''
Sysdig Sage Tool
This tool provides functionality to interact with Sysdig Sage, allowing users to generate SysQL queries based on natural language questions and execute them against the Sysdig API.
'''
...
class SageTools:
    ...
    This class provides methods to generate SysQL queries based on natural language questions
    and execute them against the Sysdig API.
    """
    ...
    async def tool_sysdig_sage(self, ctx: Context, question: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = create_standard_response(
                ...
                metadata_kwargs={"question": question, "sysql": syslq_query}
            )
