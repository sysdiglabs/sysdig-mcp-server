...
type KubernetesListTopMemoryConsumedWorkload struct {
	SysdigClient sysdig.ExtendedClientWithResponsesInterface
}

func NewKubernetesListTopMemoryConsumedWorkload(sysdigClient sysdig.ExtendedClientWithResponsesInterface) *KubernetesListTopMemoryConsumedWorkload {
	return &KubernetesListTopMemoryConsumedWorkload{
		SysdigClient: sysdigClient,
	}
}

func (t *KubernetesListTopMemoryConsumedWorkload) RegisterInServer(s *server.MCPServer) {
	tool := mcp.NewTool("kubernetes_list_top_memory_consumed_workload",
...
func (t *KubernetesListTopMemoryConsumedWorkload) handle(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
